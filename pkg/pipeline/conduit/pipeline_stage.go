...
//
//     layout, err := conduit.NewPipelineLayout(
//             conduit.NewPipelineStage(
//                      conduit.Do(aDataProcessor).Outputs(anotherDataProcessor),
//                      // ...
//             ),
//             // ...
//     )
//
// Notice how the conduit.Do() and Outputs() functions allow you to insert
