...
// type that will wrap it for internal processing.
...
// call Outputs to specify which DataProcessor instances should receive
// output JSON from the current *dataProcessor
